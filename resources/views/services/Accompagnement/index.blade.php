                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 40px;">
                                        <div class="gdlr-core-title-item-title-wrap ">
                                            <h4 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 40px;font-weight: 700;letter-spacing: 0px;text-transform: none;"> Accompagnement Plan média et Pilotage
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 5px; text-align: justify;">
                                        <div class="gdlr-core-text-box-item-content" style="font-size: 15px;">
                                            <p>
                                                « <a href="{{ route('root_path') }}">L’@gence Com</a> » construit votre plan média et pilote votre communication. Le plan média est un outil de planification détaillé et chiffré qui permet aux décideurs d’avoir une vision claire et précise de leurs campagnes.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 5px; text-align: justify;">
                                        <div class="gdlr-core-text-box-item-content" style="font-size: 15px;">
                                            <p> 
                                                « <a href="{{ route('root_path') }}">L’@gence Com</a> » , agence de communication, vous propose une planification détaillant chaque support de communication et
                                                la démarche à envisager pour atteindre les objectifs fixés.
                                    ...
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 5px; text-align: justify;">
                                        <div class="gdlr-core-text-box-item-content" style="font-size: 15px;">
                                            <p>
                                                Pour les entreprises souhaitant externaliser le suivi de leur communication, « <a href="{{ route('root_path') }}">L’@gence Com</a> » peut intervenir dans le cadre du pilotage de leur plan média: Nous assurons alors le suivi, la mise en place, la réalisation et la gestion des différents interlocuteurs du
                                                projet proposé.                                    
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-image-item gdlr-core-item-pdlr gdlr-core-item-pdb  gdlr-core-center-align">
                                        <div class="gdlr-core-image-item-wrap gdlr-core-media-image  gdlr-core-image-item-style-rectangle" style="border-width: 0px;"><img src="/assets/upload/Accompagnement.jpg" width="619" height="418"  alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-pbf-wrapper-full-no-space">
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                        <div class="gdlr-core-text-box-item-content" style="text-align: justify; margin-right: 2em; ">
                                            <p>
                                                Afin de clarifier votre vision stratégique et vous
                                                aider à organiser votre communication, il est possible
                                                de concevoir un plan média.
                                            </p>

                                            <p>
                                                Véritable planification détaillée de vos supports de
                                                communication, cet outil de travail donne le tempo et
                                                vous aide à piloter vos campagnes de
                                                communication selon les périodicités éventuelles et
                                                les moments clés de votre activité.
                                            </p>

                                            <p>
                                                « <a href="{{ route('root_path') }}">L’@gence com</a> » se positionne comme un véritable
                                                partenaire et met son expertise à votre service pour
                                                l’organisation de votre plan de communication.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-hide-in-mobile">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="margin: 0px 0px 0px 0px;padding: 0px 0px 0px 0px;" data-sync-height="service-screen-height">
                            <div class="gdlr-core-pbf-background-wrap">
                                <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(/assets/images/Services3.jpg);background-size: cover;background-position: bottom left;" data-parallax-speed="0.2"></div>
                            </div>
                    ...
                    <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 250px 0px 250px 0px;" data-sync-height="video-bg-height" data-sync-height-center>
                            <div class="gdlr-core-pbf-background-wrap" style="background-color: #161616 ;">
                                <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(/assets/images/Services4.jpg);opacity: 0.38;background-size: cover;background-position: center;" data-parallax-speed="0.1"></div>
                            </div>
                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content" style="max-width: 580px;">
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 20px;">
                                        <div class="gdlr-core-text-box-item-content" style="text-align: justify; margin-right: 2em; ">
                                            <p>
                                                Complémentaire au plan média, le prévisionnel
                                                budgétaire détaille chaque poste de dépenses en
                                                fonction de sa nature.
                                            </p>

                                            <p>
                                                « <a href="{{ route('root_path') }}">L’@gence com</a> » vous aide ainsi à avoir
                                                une visibilité financière sur vos investissements
                                                publicitaires à venir. L’autre intérêt de cette étude
                                                chiffrée est qu’elle vous permettra de mieux
                                                appréhender l’impact de votre budget communication.
                                            </p>

                                            <p>
                                                Vous pourrez ainsi avoir une vision globale de ce
                                                poste budgétaire et optimiser le R.O.I. en
                                                sélectionnant les meilleurs leviers de croissance.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content" style="max-width: 640px;">
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                        <div class="gdlr-core-text-box-item-content" style="text-align: justify; margin-right: 2em; ">
                                            <p>
                                                Parce qu’il est parfois difficile de tout gérer,
                                                « <a href="{{ route('root_path') }}">L’@gence com</a> » propose aux entreprises un
                                                service d’externalisation de la gestion de leur
                                                communication.
                                            </p>

                                            <p>
                                                « <a href="{{ route('root_path') }}">L’@gence com</a> » vous accompagne et
                                                pilote tous les processus techniques et créatifs : suivi
                                                du plan média, mise en œuvre des actions, gestion des
                                                intervenants, synchronisation des campagnes (radio,
                                                affichage ou autre)...
                                                
                                            </p>

                                            <p>
                                                Cela vous permet de rester concentré sur votre
                                                activité et d’avoir la garantie que votre plan média est
                                                suivi. En un mot, la sérénité.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-hide-in-mobile">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="margin: 0px 0px 0px 0px;padding: 0px 0px 0px 0px;" data-sync-height="service-screen-height">
                            <div class="gdlr-core-pbf-background-wrap">
                                <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(/assets/images/Services5.jpg);background-size: cover;background-position: bottom left;" data-parallax-speed="0.2"></div>
                            </div>
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                    </div>
