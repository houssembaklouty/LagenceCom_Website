@extends('layouts/master', ['title' => 'Conseil'])
                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js " style="max-width: 620px;">
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 10px;">
                                        <div class="gdlr-core-title-item-title-wrap ">
                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 40px;font-weight: 500;letter-spacing: 0px;text-transform: none;"> Conseil<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span></h3></div>
                                    </div>
                                </div>
                                <div class="gdlr-core-pbf-element">
                                    ...
                                    <div class="gdlr-core-image-item gdlr-core-item-pdlr gdlr-core-item-pdb  gdlr-core-center-align" style="padding-bottom: 22px;">
                                        <div class="gdlr-core-image-item-wrap gdlr-core-media-image  gdlr-core-image-item-style-rectangle" style="border-width: 0px;">
                                            <a href="{{ route('Conseil_diagnostic_strategique.index') }}">
                                                <img src="/assets/images/Services1.jpg" width="700" height="765" alt=""><span class="gdlr-core-image-overlay "><i class="gdlr-core-image-overlay-icon fa fa-external-link gdlr-core-size-22"></i></span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" id="gdlr-core-title-item-id-64948">
                                        <div class="gdlr-core-title-item-title-wrap ">
                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 15px;font-weight: 500;letter-spacing: 0px;text-transform: none;">
                                                <a href="{{ route('Conseil_diagnostic_strategique.index') }}" target="_self">DIAGNOSTIC STRATÉGIQUE</a><span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                    ...
                                    <div class="gdlr-core-image-item gdlr-core-item-pdlr gdlr-core-item-pdb  gdlr-core-center-align" style="padding-bottom: 22px;">
                                        <div class="gdlr-core-image-item-wrap gdlr-core-media-image  gdlr-core-image-item-style-rectangle" style="border-width: 0px;">
                                            <a href="{{ route('Conseil_strategie_communication.index') }}">
                                                <img src="/assets/images/Services2.jpg" width="700" height="765" alt=""><span class="gdlr-core-image-overlay "><i class="gdlr-core-image-overlay-icon fa fa-external-link gdlr-core-size-22"></i></span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" id="gdlr-core-title-item-id-37946">
                                        <div class="gdlr-core-title-item-title-wrap ">
                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 15px;font-weight: 500;letter-spacing: 0px;text-transform: none;">
                                                <a href="{{ route('Conseil_strategie_communication.index') }}" target="_self">STRATÉGIE DE COMMUNICATION</a>
