                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 40px;">
                                        <div class="gdlr-core-title-item-title-wrap ">
                                            <h4 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 40px;font-weight: 700;letter-spacing: 0px;text-transform: none;">Stratégie de communication
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 5px; text-align: justify;">
                                        <div class="gdlr-core-text-box-item-content" style="font-size: 15px;">
                                            <p>
                                                « <a href="{{ route('root_path') }}">L’@gence Com</a> », guide les entreprises dans leur stratégie de communication.
                                                Focalisés sur leur développement commercial, les dirigeants négligent bien souvent l’aspect stratégique de leur communication; Or, écouter, analyser et mettre en place un plan de communication est un réel levier de développement.                                   
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 5px; text-align: justify;">
                                        <div class="gdlr-core-text-box-item-content" style="font-size: 15px;">
                                            <p> 
                                                « <a href="{{ route('root_path') }}">L’@gence Com</a> », est une agence de communication implantée à Sfax, qui se positionne comme un spécialiste de ce domaine.
                                    ...
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 5px; text-align: justify;">
                                        <div class="gdlr-core-text-box-item-content" style="font-size: 15px;">
                                            <p>
                                                Pour mener à bien cette mission de conseil, « <a href="{{ route('root_path') }}">L’@gence Com</a> » vous propose de réaliser un Dossier de Recommandations Stratégiques en Communication décomposé en 3 modules.                                     
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-image-item gdlr-core-item-pdlr gdlr-core-item-pdb  gdlr-core-center-align">
                                        <div class="gdlr-core-image-item-wrap gdlr-core-media-image  gdlr-core-image-item-style-rectangle" style="border-width: 0px;"><img src="/assets/upload/Strategie_communication.jpg" width="619" height="418"  alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-pbf-wrapper-full-no-space">
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                        <div class="gdlr-core-text-box-item-content" style="text-align: justify; margin-right: 2em; ">
                                            <p>
                                                Après un audit de l’existant et la mise en avant de votre problématique, « L’@gence com » définit le profil de votre cible principale et éventuellement secondaire. Ensuite, nous déterminons les différents prescripteurs de votre entreprise, véritables relais d’opinion à ne pas sous-estimer.
                                            </p>

                                            <p>
                                                Enfin, notre étude met en exergue les motivations et freins de vos cibles ainsi que les objectifs de communication et ce, afin de les intégrer à la démarche globale. 
                                            </p>

                                            <p>
                                                La conclusion de ce module est la définition d’un nouveau positionnement, défini comme la façon dont votre entreprise veut être perçue par son public.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-hide-in-mobile">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="margin: 0px 0px 0px 0px;padding: 0px 0px 0px 0px;" data-sync-height="service-screen-height">
                            <div class="gdlr-core-pbf-background-wrap">
                                <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(/assets/upload/Strategie_c.jpg);background-size: cover;background-position: bottom left;" data-parallax-speed="0.2"></div>
                            </div>
                    ...
                    <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 250px 0px 250px 0px;" data-sync-height="video-bg-height" data-sync-height-center>
                            <div class="gdlr-core-pbf-background-wrap" style="background-color: #161616 ;">
                                <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(/assets/upload/Strategie_m.jpg);opacity: 0.38;background-size: cover;background-position: center;" data-parallax-speed="0.1"></div>
                            </div>
                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content" style="max-width: 580px;">
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 20px;">
                                        <div class="gdlr-core-text-box-item-content" style="text-align: justify; margin-right: 2em; ">
                                            <p>
                                                Dans ce module créatif décomposé en 4 parties, « L’@gence com » vous propose de nouveaux slogans. Afin d’avoir une vision objective et faciliter la prise de décision, un scoring est réalisé en interne. 
                                            </p>

                                            <p>
                                                Le slogan le mieux noté vous est alors soumis accompagné d’une argumentation justifiant sa pertinence et son interprétation par votre cible. 
                                            </p>

                                            <p>
                                               Enfin, nous fixons les axes créatifs et contraintes à prendre en considération pour la réalisation de la nouvelle identité visuelle et des supports graphiques associés (print, digital, signalétique).
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content" style="max-width: 640px;">
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                        <div class="gdlr-core-text-box-item-content" style="text-align: justify; margin-right: 2em; ">
                                            <p>
                                                Dans ce module final, « L’@gence com » détaille les différents leviers média et hors-média à mettre en oeuvre pour atteindre vos objectifs.
                                            </p>

                                            <p>
                                                En prenant en compte les conclusions des modules de stratégie markéting et créative, nous bâtissons un plan média détaillé pour vous permettre de structurer, d’organiser et de planifier votre communication sur une période d’un an.
                                            </p>

                                            <p>
                                                En définitif, une prévision budgétaire du plan média est réalisée afin de mieux piloter vos investissements publicitaires et vous aider à améliorer votre R.O.I (Return On Investment).
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-hide-in-mobile">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="margin: 0px 0px 0px 0px;padding: 0px 0px 0px 0px;" data-sync-height="service-screen-height">
                            <div class="gdlr-core-pbf-background-wrap">
                                <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(/assets/upload/Strategie_o.jpg);background-size: cover;background-position: bottom left;" data-parallax-speed="0.2"></div>
                            </div>
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js  gdlr-core-sync-height-content"></div>
                        </div>
                    </div>
