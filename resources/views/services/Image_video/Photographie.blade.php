                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 40px;">
                                        <div class="gdlr-core-title-item-title-wrap ">
                                            <h4 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 40px;font-weight: 700;letter-spacing: 0px;text-transform: none;"> Photographie
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 5px; text-align: justify;">
                                        <div class="gdlr-core-text-box-item-content" style="font-size: 15px;">
                                            <p>
                                                « <a href="{{ route('root_path') }}">L’@gence Com</a> », réalise vos photos d’entreprise & met en lumière votre savoir faire et vos talents.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 5px; text-align: justify;">
                                        <div class="gdlr-core-text-box-item-content" style="font-size: 15px;">
                                            <p>
                                                Dans un monde où les dirigeants cherchent à mettre en avant l’image de leur société, « <a href="{{ route('root_path') }}">L’@gence Com</a> » vous propose ses services de photographie professionnelle. Les possibilités sont multiples : du portrait d’équipe en studio à la réalisation d’un shooting produits ou
                                                l’illustration de vos campagnes publicitaires... 
                                    ...
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 5px; text-align: justify;">
                                        <div class="gdlr-core-text-box-item-content" style="font-size: 15px;">
                                            <p>
                                                Notre valeur ajoutée en tant qu’agence: Vous accompagner sur vos projets photos dans le respect de votre stratégie globale d’image.                                     
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="gdlr-core-pbf-wrapper " style="padding: 0px 0px 30px 0px;">
            ...
            <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
                <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-pbf-wrapper-full-no-space">
                    ...
                    <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 50px 0px 50px 40px;" data-sync-height="service-screen-height">
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                        <div class="gdlr-core-text-box-item-content" style="text-align: justify; margin-right: 2em; ">
                                            <p>
                                                <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 30px;font-weight: 500;letter-spacing: 0px;text-transform: none;">
                                                    • Photos corporate:
                                                    <span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span>
                                                </h3>
                                                 La photographie corporate vous permet de mettre en avant le quotidien de votre entreprise: portrait individuel de salarié en situation, équipe... Ces clichés vous permettront notamment d’illustrer vos supports publicitaires (plaquette,
                                                brochure, signature email...).                                                
                                            </p>
                                            ...
                                            <p>
                                                ...
                                                Les photographies portrait permettent de valoriser vos collaborateurs d’une manière professionnelle et dans le respect du positionnement marketing de votre entreprise. Par ailleurs, recourir aux portraits permet à vos clients d’identifier plus
                                                facilement leur(s) interlocuteur(s). « <a href="{{ route('root_path') }}">L’@gence Com</a> » s’adapte à votre style en vous proposant du portrait en studio ou du portrait
                                                en situation.
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="gdlr-core-pbf-column gdlr-core-column-30">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 50px 70px 75px 77px;" data-sync-height="video-bg-height">
                                    ...
                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 20px;">
                                        <div class="gdlr-core-text-box-item-content" style="text-align: justify; margin-right: 2em; ">
                                            ...
                                            <p>
                                                ...
                                                Elément clé de votre communication, la photographie d’illustration vous permet de promouvoir des outils de
                                                production, un processus industriel, vos équipes ou le savoir-faire d’une façon originale et esthétique. Ces images sur
                                                mesure apporteront une approche inédite de votre activité.
                                            </p>
                                            ...
                                            <p>
                                                ...
                                                « <a href="{{ route('root_path') }}">L’@gence Com</a> » vous propose également de réaliser vos shootings de produits ou de packaging en studio. Ces
                                                clichés professionnels pourront ensuite être utilisés pour votre catalogue produits ou encore pour l’illustration des fiches
                                                produits de votre boutique en ligne. 
                                            </p>
